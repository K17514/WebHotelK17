            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="<?= base_url('gudang/update_profile') ?>" method="post" enctype="multipart/form-data">
              ...
              <?php endif; ?>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          ...
                          <a href="<?= base_url('gudang/delete_profile_picture') ?>" class="btn btn-danger btn-sm" title="Remove my profile image">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="<?= base_url('gudang/change_pass') ?>" method="post">
              ...
              <?php endif; ?>
                    ...
                    <div class="text-center">
                      ...
                      <a href="<?= base_url('gudang/reset_pass/'.$chelsica->id_user)?>" class="btn btn-danger"></i>Reset Password</a>
                    </div>
