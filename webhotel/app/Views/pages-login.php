            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?=base_url('/gudang/aksi_login/')?>" method="POST"class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Bro what's your email? enter pls.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Did bro forgor? if not, enter pls.</div>
                    </div>

                     <div class="col-12 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="remember" value="true" id="rememberMe">
                      <label class="small text" for="rememberMe">Lazy to remember pswd</label>
                    </div>
                    <a href="<?=base_url('/home/forgorpass/')?>" class="small text-primary">Forgot Password?</a>
                  </div>
                    <div class="col-12">
                      <button class="btn btn-danger w-100" type="submit">Login</button>
                    </div>  
                    <div class="col-12">
                      <p class="small mb-0">You dont have account? Who are you? <a href="<?=base_url('/home/register/')?>">Create an account</a></p>
                    </div>
                  </form>
